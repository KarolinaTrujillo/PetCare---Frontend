...
import { MascotasToolbarProps } from "../model/dto/props/MascotasToolbarProps";

export default function MascotasToolbar({ busqueda, onBusqueda, userName }: MascotasToolbarProps) {
  return (
