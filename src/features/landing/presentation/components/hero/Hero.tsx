...
export const HeroComponent = () => {
  ...
  return (
    <section className="relative min-h-screen bg-white flex items-center px-6 md:px-14 lg:px-24 py-16 md:py-24 font-sans overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <div className="flex flex-col gap-6 animate-[fadeUp_0.7s_ease_both]">
          ...
          <h1 className="font-serif text-[#000000] leading-[1.1] text-4xl md:text-6xl lg:text-7xl font-bold">
            Cuidamos a tu{' '}
          ...
          <div className="flex gap-6 md:gap-10 mt-4 pt-6 border-t border-gray-100">
            {[
              ...
              <div key={label}>
                <p className="font-serif text-[#000000] text-2xl md:text-3xl font-semibold">{num}</p>
        ...
        <div className="relative flex justify-center items-center h-[300px] md:h-[520px]">
          ...
          <div className="relative z-10 w-[220px] h-[260px] md:w-[380px] md:h-[420px] animate-bounce [animation-duration:3s] [animation-timing-function:ease-in-out]">
            <Image src="/pet.webp" alt="Mascota" fill className="object-contain" priority />
          </div>

          {/* Card próxima cita */}
          <div className="absolute bottom-6 -left-2 md:bottom-10 z-20 bg-white rounded-2xl shadow-lg border border-black/[0.04] px-3 py-2 md:px-4 md:py-3 flex items-center gap-2 md:gap-3">
            <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-[#267A6E] flex items-center justify-center flex-shrink-0">
            ...
            <div>
              ...
              <p className="text-xs md:text-sm font-medium text-[#000000]">Hoy, 3:00 PM</p>
            </div>
          </div>

          {/* Card valoración */}
          <div className="absolute top-6 -right-2 md:top-10 z-20 bg-white rounded-2xl shadow-lg border border-black/[0.04] px-3 py-2 md:px-4 md:py-3 flex items-center gap-2 md:gap-3">
            <div className="w-8 h-8 md:w-9 md:h-9 rounded-full bg-[#267A6E]/10 flex items-center justify-center flex-shrink-0">
              <svg className="w-3.5 h-3.5 md:w-4 md:h-4 text-[#267A6E]" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
              </svg>
            </div>
            <div>
              <p className="text-[0.7rem] text-gray-400 font-light">Valoración</p>
              <p className="text-xs md:text-sm font-medium text-[#000000]">4.9 / 5.0</p>
            </div>
          </div>
        </div>
