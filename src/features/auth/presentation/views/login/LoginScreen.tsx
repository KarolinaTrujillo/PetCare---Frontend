      ...
      <div className="flex flex-1">
        <div className="flex flex-1 flex-col justify-center px-10 md:px-24 lg:px-36 py-12">
          <div className="w-full max-w-sm">
            ...
            <p className="text-sm text-gray-400 mb-8">Bienvenido de nuevo</p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Link href={Routes.auth.forgotPassword} className="text-xs text-[#267A6E] hover:underline self-end mt-0.5">
            ...
            <p className="text-center text-sm text-gray-400 mt-6">
              ¿No tienes cuenta?{' '}
              <Link href={Routes.auth.register} className="text-[#267A6E] font-medium hover:underline">
                Regístrate
              </Link>
            </p>
